  ...
  const routineTemplates = [
    {
      ...
      icon: '💧',
      description: 'Keep your crown moisturized and healthy with a quick moisture refresh',
      category: 'hydrating',
      isDefault: true,
      frequency: 'daily',
      estimatedMinutes: 5,
      isActive: true,
      targetHairTypes: [] as string[],
      targetPorosities: ['HIGH'] as string[],
      targetGoals: ['MOISTURE', 'HEALTH'] as string[],
    },
    {
      name: 'Silk Refresh',
      icon: '✨',
      description: 'Refresh your style and keep it looking fresh between wash days',
      category: 'refreshing',
      isDefault: true,
      frequency: 'daily',
      estimatedMinutes: 3,
      isActive: true,
      targetHairTypes: [] as string[],
      targetPorosities: [] as string[],
      targetGoals: [] as string[],
    },
    {
      name: 'Golden Oil Ritual',
      icon: '🌟',
      description: 'Nourish your scalp and strands with a luxurious oil therapy session',
      category: 'oiling',
      isDefault: true,
      frequency: 'weekly',
      estimatedMinutes: 10,
      ...
      targetHairTypes: [] as string[],
      targetPorosities: [] as string[],
      targetGoals: ['LENGTH', 'HEALTH'] as string[],
    },
    {
      name: 'Freedom Day',
      icon: '🦋',
      description: 'Time to undo your protective style with care and patience',
      category: 'undoing',
      isDefault: true,
      frequency: 'monthly',
      estimatedMinutes: 30,
    ...
    },
    {
      name: 'Cleanse & Shine',
      icon: '🧼',
      description: 'Wash day for a fresh start — cleanse, condition and define',
      category: 'washing',
      isDefault: true,
      frequency: 'weekly',
      estimatedMinutes: 45,
      ...
      targetHairTypes: [] as string[],
      targetPorosities: [] as string[],
      targetGoals: ['HEALTH', 'MOISTURE'] as string[],
    },
    {
      name: 'Deep Treatment',
      icon: '💆',
      description: 'Deep conditioning treatment for extra strength and moisture',
      category: 'hydrating',
      isDefault: true,
      frequency: 'weekly',
      estimatedMinutes: 30,
      ...
      targetHairTypes: [] as string[],
      targetPorosities: [] as string[],
      targetGoals: ['MOISTURE', 'DAMAGE_REPAIR', 'HEALTH'] as string[],
    },
    {
      name: 'Scalp Massage',
      icon: '🤲',
      description: 'Stimulate growth and circulation with a relaxing scalp massage',
      category: 'oiling',
      isDefault: true,
      frequency: 'daily',
      estimatedMinutes: 5,
      ...
      targetHairTypes: [] as string[],
      targetPorosities: [] as string[],
      targetGoals: ['LENGTH', 'DENSITY'] as string[],
    },
    {
      name: 'Protective Set',
      icon: '🛡️',
      description: 'Set your protective style for the month ahead',
      category: 'protective',
      isDefault: true,
      frequency: 'monthly',
      estimatedMinutes: 60,
  ...
  for (const t of routineTemplates) {
    await prisma.routineTemplate.upsert({
      ...
      update: {
        ...
        isActive: t.isActive,
        targetHairTypes: t.targetHairTypes,
        targetPorosities: t.targetPorosities,
